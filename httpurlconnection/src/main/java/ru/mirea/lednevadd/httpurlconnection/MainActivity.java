package ru.mirea.lednevadd.httpurlconnection;
...
import ru.mirea.lednevadd.httpurlconnection.databinding.ActivityMainBinding;
...
//            binding.weatherView.setText(result);
            ...
            try {
                ...
                binding.city.setText("Город: " + responseJson.getString("city"));
                binding.region.setText("Регион: " + responseJson.getString("region"));
                binding.country.setText("Страна: " + responseJson.getString("country"));
        ...
        private class RequestWeatherInfo extends DownloadPageTask {
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    binding.weather.setText("Погода: \n" +
